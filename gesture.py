...
# Button for clicks and controller for mouvements
from pynput.mouse import Button, Controller

# WX Library is used To get the Screen Access
# wx for GUI
import wx
...
def leftClick():
    ...
    app = wx.App(False)
    # sx=screen x co-ordinate ; sy = screen y co-ordinate
    (sx, sy) = wx.GetDisplaySize()
    # Resolution in which Camera will Display
    (camx, camy) = (480, 320)

    # numpy range for Color to be detected - [ H, S, V]
